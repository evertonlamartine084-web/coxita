  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        ...
        {/* ============ HERO ============ */}
        <section className="relative bg-brand dots-sun border-b-[6px] border-brown">
          <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
            <div className="grid md:grid-cols-12 items-center gap-12 md:gap-16">
              <div className="md:col-span-7">
                ...
                {/* Cada linha entra palavra por palavra. O delay da segunda
                    linha comeca depois que a primeira terminou de assentar. */}
                <h1 className="font-display text-6xl sm:text-7xl md:text-[5.5rem] font-black uppercase leading-[0.82] tracking-[-0.035em] mb-7 text-brown">
                  <SplitText as="span" className="block" delay={120}>
                    Salgado de festa.
                  </SplitText>
                  <SplitText
                    as="span"
                    className="block text-cream [-webkit-text-stroke:2px_#5d2b04]"
                    delay={360}
                  >
                    Recheio de verdade.
                  </SplitText>
              ...
              <Reveal delay={100} className="md:col-span-5 relative py-5 pr-3">
                {/* Moldura estampada deslocada por tras da foto: o "offset print"
        ...
        {/* ============ OLHA O RECHEIO ============ */}
        {/* Vem antes da vitrine de sabores: e a secao que da vontade, e a
            vitrine logo abaixo mostra tudo que da pra escolher. */}
        <section className="bg-brown py-14 md:py-18 border-b-[6px] border-brown">
          <Reveal>
            <FlavorSpotlight flavors={flavors} />
          </Reveal>
        </section>
