...
import { consultarPedidoPorToken } from '../../services/orders'
import { getSettings } from '../../services/settings'
import Button from '../../components/ui/Button'
import Loading from '../../components/ui/Loading'
import ShareButtons from '../../components/share/ShareButtons'
import AvisoPush from '../../components/checkout/AvisoPush'
import { formatCurrency, PAYMENT_LABELS } from '../../utils/format'
import toast from 'react-hot-toast'
import { linkDoPedido, tokenDoPedido } from '../../utils/pedidosLocais'
...
export default function OrderConfirmationPage() {
  ...
  useEffect(() => {
    Promise.all([
      consultarPedidoPorToken(tokenDoPedido(orderNumber) ?? ''),
      getSettings(),
    ])
  ...
  return (
    <>
      <Seo titulo="Pedido confirmado" noindex />
        ...
        <div className="max-w-xl mx-auto px-4 py-10 md:py-14">
          ...
          <div className="text-center mb-8">
            ...
            <div className="bg-surface border-3 border-brown p-6 my-6 shadow-[5px_5px_0_#ffcd5e]">
              ...
              <p className="font-display text-5xl font-black text-primary mt-1">{order?.codigo_cliente ? `#${order.codigo_cliente}` : `#${orderNumber}`}</p>
            </div>

            {/* o registro do push acontece aqui, e não só na tela de acompanhamento: quem pedia e
                fechava o site nunca chegava a ter assinatura nenhuma */}
            <AvisoPush orderNumber={order?.order_number} />
          ...
          <Link to={linkDoPedido(orderNumber)} className="block mt-5">
